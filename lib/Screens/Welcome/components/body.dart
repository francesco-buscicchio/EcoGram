...
class Body extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Background(
      ...
      children: <Widget>[
        const Text("Welcome to EcoGram", style: TextStyle(fontWeight: FontWeight.bold)),
        SizedBox(height: size.height * 0.05),
        SvgPicture.asset("assets/icons/chat.svg",height: size.height * 0.45),
        SizedBox(height: size.height * 0.05),
        RoundedButton(text: "LOGIN", press: (){}),
        RoundedButton(text: "SIGNUP", press: (){}, color: kPrimaryLightColor, textColor: Colors.black,)
      ]
      )
    );
  }
